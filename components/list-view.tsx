...
import { AlertTriangle, CheckCircle, Edit, Mail, Phone, Search, Trash2, CheckCircle2, Clock } from 'lucide-react'
...
export function ListView({ players, onEditPlayer, onVisitStatusChange, onRefresh }: ListViewProps) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent className="bg-white border-gray-300">
                  <SelectItem value="all" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Tutti gli Stati</SelectItem>
                  <SelectItem value="valid" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Valide</SelectItem>
                  <SelectItem value="expiring_soon" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">In Scadenza</SelectItem>
                  <SelectItem value="expired" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Scadute</SelectItem>
                </SelectContent>
              </Select>
              ...
              <Select value={positionFilter} onValueChange={setPositionFilter}>
                ...
                <SelectContent className="bg-white border-gray-300">
                  <SelectItem value="all" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Tutti i Ruoli</SelectItem>
              ...
              <Select value={visitFilter} onValueChange={setVisitFilter}>
                ...
                <SelectContent className="bg-white border-gray-300">
                  <SelectItem value="all" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Tutte le Visite</SelectItem>
                  <SelectItem value="completed" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">Completate</SelectItem>
                  <SelectItem value="pending" className="text-base sm:text-lg text-gray-800 hover:bg-gray-100">In Attesa</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
              ...
              {filteredPlayers.map((player) => (
                <div key={player.id} className={`rounded-lg p-3 sm:p-4 border-2 transition-all duration-200 ${
                  ...
                  <div className="flex items-start justify-between mb-3 sm:mb-4 gap-2">
                    ...
                    <Badge variant={getStatusColor(player.status)} className="flex items-center gap-1 px-2 py-1 text-xs sm:text-sm flex-shrink-0">
                  ...
                  <div className="mb-3 sm:mb-4">
                    ...
                    <p className={`font-bold text-base sm:text-lg ${
                      getDaysUntilExpiry(player.medical_expiry_date) < 0 ? 'text-red-600' :
                      getDaysUntilExpiry(player.medical_expiry_date) <= 30 ? 'text-orange-600' :
                      'text-green-600'
                    }`}>

...
import { ClientOnboarding, SubscriptionPlan } from '@/lib/backoffice-types'

interface ClientOnboardingFormProps {
  isOpen: boolean
  onClose: () => void
  onSubmit: (clientData: ClientOnboarding) => void
  isLoading?: boolean
}
...
export function ClientOnboardingForm({ isOpen, onClose, onSubmit, isLoading = false }: ClientOnboardingFormProps) {
  ...
  const handleInputChange = (field: keyof ClientOnboarding, value: string | number) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const finalData: ClientOnboarding = {
      ...formData,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Onboarding Nuovo Cliente</h2>
                <p className="text-gray-600">Configura il nuovo cliente e il suo piano abbonamento</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Informazioni Password Temporanea */}
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
            ...
            <p className="text-yellow-700 text-sm mb-3">
              Al cliente verrà inviata automaticamente una password temporanea generata dal sistema.
              Potrà poi cambiarla al primo accesso.
            </p>
            <div className="flex items-center gap-2">
              <Input
                value={generateTemporaryPassword()}
                readOnly
                className="bg-white border-yellow-300 text-yellow-800 font-mono"
              />
              <Button
                type="button"
                variant="outline"
                ...
                onClick={() => {
                  ...
                  // Qui si potrebbe aggiornare lo stato se necessario
                }}
